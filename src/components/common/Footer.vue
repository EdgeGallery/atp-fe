...
import { PLATFORMNAME_APPSTORE, PLATFORMNAME_DEVELOPER, PLATFORMNAME_MECM } from '../../tools/constant.js'
export default {
  name: 'Layout',
  components: {
    EgFooter
  ...
  methods: {
    ...
    getPlatformUrl () {
      ...
      this.devUrl = common.getPlatformUrlPrefix(PLATFORMNAME_DEVELOPER)
